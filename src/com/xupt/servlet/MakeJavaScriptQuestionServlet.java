...
public class MakeJavaScriptQuestionServlet extends HttpServlet {

	/**
	 * Constructor of the object.
	 */
	public MakeJavaScriptQuestionServlet() {
		super();
	}
	...
	public void doPost(HttpServletRequest request, HttpServletResponse response)
			throws ServletException, IOException {
		System.out.println("进入MakeQuestionServlet");
